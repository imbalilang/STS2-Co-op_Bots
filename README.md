...
## 最新更新 / Latest：0.38.1（2026-09-22）

- **战斗外等待大幅缩短**：路线投票 / 商店 / 奖励 / 宝箱遗物的 2 秒节流改为"只在房间或战斗切换时付一次"，同一房间内按 250ms 推进（四席投票约 8 秒 → 约 1 秒）。
...
**已发布版本 0.38.1**，安装包 `outputs/CoopBots-v0.38.1.zip`。运行目标为游戏 v0.111.0，
