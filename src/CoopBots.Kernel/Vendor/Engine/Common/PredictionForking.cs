...
internal interface ICombatPredictionStateOwner
{
    void AttachPredictionState(
        CoopBots.Kernel.Vendor.Engine.InCombat.Simulation.CombatPredictionState predictionState);
}
...
{
    void MaterializeRoot(CoopBots.Kernel.Vendor.Engine.InCombat.Simulation.CombatPredictionSimulator simulator);
}
...
internal interface ICombatPredictionCardEventSink
{
    ...
    void AfterCardRemovedFromCombat(CoopBots.Kernel.Vendor.Engine.Common.PredictedCard card);
...
internal interface ICombatPredictionChoiceSink
{
    ...
    bool ResolvePileDiscardChoice(
        ...
        MegaCrit.Sts2.Core.Entities.Players.Player player,
        MegaCrit.Sts2.Core.Entities.Cards.PileType sourcePile,
        IReadOnlyList<CoopBots.Kernel.Vendor.Engine.Common.PredictedCard> options,
