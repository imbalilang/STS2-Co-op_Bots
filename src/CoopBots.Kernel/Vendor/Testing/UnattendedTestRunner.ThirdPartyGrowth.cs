...
{
    private const string ThirdPartyGrowthTestId = "CoopBots.Kernel.Vendor.Test.ThirdPartyGrowth";
    private const string ThirdPartyGrowthUnloadedId = "CoopBots.Kernel.Vendor.Test.UnloadedMod";
