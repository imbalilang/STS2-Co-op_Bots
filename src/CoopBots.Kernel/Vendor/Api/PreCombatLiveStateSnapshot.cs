...
namespace CoopBots.Kernel.Vendor.Api;
    ...
    byte[]? SerializedPlanningRun = null)
{
    ...
    public static PreCombatLiveStateSnapshot Capture(RunState run)
    {
        ...
        return new PreCombatLiveStateSnapshot(
            ...
            global::CoopBots.Kernel.Vendor.SolverSettings.CaptureSerializedSettings(),
            mods);
    }
    ...
    private static string ComputeToken(byte[] serialized, RunState run)
    {
        ...
        byte[] suffix = Encoding.UTF8.GetBytes(
            ...
            $"|solver_settings={Convert.ToHexString(SHA256.HashData(global::CoopBots.Kernel.Vendor.SolverSettings.CaptureSerializedSettings()))}");
